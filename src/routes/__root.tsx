...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Aura Bio — Soins naturels tunisiens" },
      {
        name: "description",
        content:
          "Aura Bio, marque tunisienne de soins naturels pour la peau, les cheveux et le corps. Livraison partout en Tunisie, paiement à la livraison.",
      },
      { property: "og:site_name", content: "Aura Bio" },
